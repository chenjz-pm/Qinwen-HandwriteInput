...
class SEModule(nn.Module):
    def __init__(self, channels, ratio=16):
        ...
        self.fc1 = nn.Conv2d(channels, channels // ratio, kernel_size=1, padding=0)
        self.mish = nn.Mish(inplace=True)
        self.fc2 = nn.Conv2d(channels // ratio, channels, kernel_size=1, padding=0)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes,groups, stride=1, downsample=None, norm_layer=None,
        ...
        self.stride = stride
        self.se = SEModule(planes // self.reduction)
